...
view VW_CRIT_PSH_PG {
	type main is
		select A1(
			...
			to_date(sys_context(user_context, '$VW$_CALC_DATE'), 'DD/MM/YYYY')  : C_DATE_CALC, 
			...
			[GUARANTIES].[PSH_L].GETPROPVAL(A1%id, to_date(sys_context(user_context, '$VW$_CALC_DATE'), 'DD/MM/YYYY'), --[GUARANTIES].[Z1522841621].GetDateCalc,
					::[PROPERTY_GRP]([CODE] = 'PSB_DATE_END_MAIN_DOG')) : C_PSB_DATE_END_MAIN_DOG,
